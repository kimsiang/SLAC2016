// This ROOT macro is intended to be working 
// on root files produced by art analyzer
// with histograms of beam and sync pulses timing differences. 
...
void plot_dt(){
    ...
    // list of run number from beam hitting xtal0 to xtal53
	...
	if(iter%9==0 || iter%9==8) continue; // skip all the corner crystals for now
